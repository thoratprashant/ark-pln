...
import { marcoSidebarHelperService } from "./marco-sidebar-helper.service";
...
export class marcoSidebarComponent implements OnInit, OnDestroy {
  // Name
  @Input()
  name: string;
  ...
  constructor(
    ...
    private sidebarHelperService: marcoSidebarHelperService,
...
export class marcoSidebarTogglerDirective {
  @Input("marcoSidebarToggler")
  public id: any;

  constructor(private marcoSidebarHelperService: marcoSidebarHelperService) {}
