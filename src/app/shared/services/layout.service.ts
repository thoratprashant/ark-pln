  ...
  constructor(private themeService: ThemeService) {
    this.setAppLayout(
      //******** SET YOUR LAYOUT OPTIONS HERE *********
      {
        ...
        sidebarColor: "slate", // http://demos.ui-lib.com/marco-doc/#marco-colors
        sidebarCompactToggle: false, // applied when "sidebarStyle" is "compact"
        dir: "ltr", // ltr, rtl
        useBreadcrumb: true,
        topbarFixed: false,
        footerFixed: false,
        topbarColor: "white", // http://demos.ui-lib.com/marco-doc/#marco-colors
        footerColor: "slate", // http://demos.ui-lib.com/marco-doc/#marco-colors
        matTheme: "marco-blue", // marco-blue, marco-navy, marco-light-purple, marco-dark, marco-dark-pink
